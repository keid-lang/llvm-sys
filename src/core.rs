...
extern "C" {
    ...
    #[deprecated(since = "14.0", note = "Use LLVMConstInBoundsGEP2 instead to support opaque pointers.")]
...
extern "C" {
    ...
    pub fn LLVMMDStringInContext(C: LLVMContextRef, Str: *const ::libc::c_char, SLen: ::libc::c_uint) -> LLVMValueRef;
    #[deprecated(since = "LLVM 9.0", note = "Use LLVMMDStringInContext2 instead.")]
    ...
    pub fn LLVMMDNodeInContext(C: LLVMContextRef, Vals: *mut LLVMValueRef, Count: ::libc::c_uint) -> LLVMValueRef;
    #[deprecated(since = "LLVM 9.0", note = "Use LLVMMDNodeInContext2 instead.")]
...
extern "C" {
    ...
    #[deprecated(since = "14.0", note = "Deprecated in favor of the more general LLVMAddMetadataToInst.")]
    ...
    pub fn LLVMBuildLoad(arg1: LLVMBuilderRef, PointerVal: LLVMValueRef, Name: *const ::libc::c_char) -> LLVMValueRef;
    ...
    #[deprecated(since = "14.0", note = "Use LLVMBuildInBoundsGEP2 instead to support opaque pointers.")]
    ...
    #[deprecated(since = "14.0", note = "Use LLVMBuildStructGEP2 instead to support opaque pointers.")]
    ...
    #[deprecated(since = "14.0", note = "Use LLVMBuildPtrDiff2 instead to support opaque pointers.")]
